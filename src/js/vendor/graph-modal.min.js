class GraphModal {
	constructor(t) {
		;(this.options = Object.assign({ isOpen: t => {}, isClose: t => {} }, t)),
		...
		this.modal &&
			(document.addEventListener(
				...
				function (t) {
					...
					if (e) {
						let t,
							s = e.dataset.graphPath,
							i = e.dataset.graphAnimation
						return (
							(t =
								window.matchMedia && window.matchMedia('(prefers-reduced-motion: reduce)').matches
									? 100
									: e.dataset.graphSpeed),
							(this.animation = i || 'fade'),
							(this.speed = t ? parseInt(t) : 300),
							(this._nextContainer = document.querySelector(`[data-graph-target="${s}"]`)),
							void this.open()
						)
					}
	...
	open(t) {
		...
		;(this.modalContainer = this._nextContainer),
			...
			this.modalContainer.dataset.graphSpeed && (this.speed = this.modalContainer.dataset.graphSpeed),
			this.modal.style.setProperty('--trns', this.speed / 1e3 + 's'),
